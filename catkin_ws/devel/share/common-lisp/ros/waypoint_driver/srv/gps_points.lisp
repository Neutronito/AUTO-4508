...
(cl:in-package waypoint_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <gps_points-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gps_points-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_driver-srv:<gps_points-request> is deprecated: use waypoint_driver-srv:gps_points-request instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <gps_points-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_driver-srv:latitude-val is deprecated.  Use waypoint_driver-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <gps_points-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_driver-srv:longitude-val is deprecated.  Use waypoint_driver-srv:longitude instead.")
  (longitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<gps_points-request>)))
  ...
  "waypoint_driver/gps_pointsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'gps_points-request)))
  "Returns string type for a service object of type 'gps_points-request"
  "waypoint_driver/gps_pointsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <gps_points-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gps_points-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_driver-srv:<gps_points-response> is deprecated: use waypoint_driver-srv:gps_points-response instead.")))

(cl:ensure-generic-function 'reached_status-val :lambda-list '(m))
(cl:defmethod reached_status-val ((m <gps_points-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_driver-srv:reached_status-val is deprecated.  Use waypoint_driver-srv:reached_status instead.")
  (reached_status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<gps_points-response>)))
  ...
  "waypoint_driver/gps_pointsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'gps_points-response)))
  "Returns string type for a service object of type 'gps_points-response"
  "waypoint_driver/gps_pointsResponse")
